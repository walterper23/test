    ...
    <div class="block block-themed">
        <div class="block-header bg-corporate-dark">
            ...
            <div class="block-options">
                <button type="button" class="btn-block-option" onclick="App.openModal({ title : 'Ricardo', url : '/configuracion/catalogos/tipos-documentos/nuevo', id : 'form-nuevo-tipo-documento' })">
