            ...
            <div class="block">
                <div class="block-content block-content-full">
                   @include('Configuracion.Catalogo.navbarItems')
                    <div class="col-12">
                        <button type="button" class="btn btn-alt-primary" onclick="App.openModal({ title : 'Ricardo', url : '/configuracion/catalogos/departamentos/nuevo', id : 'form-nuevo-departamento' })"><i class="fa fa-plus"></i> Nuevo</button>
