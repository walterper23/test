            ...
            <div class="block">
                <div class="block-content block-content-full">
                   @include('Configuracion.Catalogo.navbarItems')
                    <div class="col-12">
                        <button type="button" class="btn btn-alt-primary" onclick="App.openModal({  url : '/configuracion/catalogos/direcciones/nuevo', id : 'form-nuevo-direcciones' })"><i class="fa fa-plus"></i> Nuevo</button>
