...
class DocumentosDataTable extends CustomDataTable
{
    ...
    {
        $this -> sourceData = MDocumento::with('TipoDocumento','Detalle','AcuseRecepcion') -> select('DOCU_DOCUMENTO','DOCU_NUMERO_DOCUMENTO','DOCU_DETALLE','DOCU_SYSTEM_TIPO_DOCTO') -> existente() -> noGuardado() -> whereNotIn('DOCU_SYSTEM_TIPO_DOCTO',[1,2]) -> get(); // Denuncias, Documentos de denuncias
    }
